...
export class DatabaseService {
  ...
  deleteUserProfessionalExperience(
    ...
    return this.http.delete(
      `${environment.databaseApiURL}/users/${userId}/professional-experience/${id}`
    ) as Observable<UserProfessionalExperience>;
  }
  ...
  deleteUserEducationalExperience(
    ...
    return this.http.delete(
      `${environment.databaseApiURL}/users/${userId}/educational-experience/${id}`
    ) as Observable<UserEducationalExperience>;
  }
  ...
  deleteUserProject(userId: number, id: number): Observable<UserProject> {
    return this.http.delete(
      `${environment.databaseApiURL}/users/${userId}/projects/${id}`
    ) as Observable<UserProject>;
  }
  ...
  addCompanyRecruiter(companyId: number, email: string, password: string) {
    return this.http.post(`${environment.apiUrl}/recruiters`, {
      companyId,
      email,
      password,
    });
  ...
  getCompanyIndustriesByCompanyId(
    ...
    return this.http.get(
      `${environment.databaseApiURL}/companies/${companyId}/industries`
  ...
  getCompanyRecruitersByCompanyId(
    ...
    return this.http.get(
      `${environment.databaseApiURL}/companies/${companyId}/recruiters`
    ) as Observable<CompanyRecruiter[]>;
  }
  ...
  getJobs(
    ...
    let URL = `${environment.filterApiURL}/jobs?page=${page}&size=${maxJobs}`;
